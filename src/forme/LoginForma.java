...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Broj licence instruktora:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtBrojLicence, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            String brojLicence = txtBrojLicence.getText();
            if (txtBrojLicence.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Unesite broj licence!");
                return;
            }

            Instruktor i = new Instruktor(0, "", "", brojLicence, false);
            ...
            if(!so.isUspesno()){
                ...
                JOptionPane.showMessageDialog(this, so.getPoruka(), "Poruka", JOptionPane.INFORMATION_MESSAGE);
                Kontroler.getInstance().setInstruktor((Instruktor) so.getArgument());
                this.dispose();
